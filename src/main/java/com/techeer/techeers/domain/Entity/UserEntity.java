package com.techeer.techeers.domain.Entity;
...
public class UserEntity {
    ...
    private int userId; // 시퀀스, auto_increment
    ...
    @Builder
    public UserEntity(int userId, String firstName, String lastName, String email, String password, String phoneNumber, String addressId) {
        this.userId = userId;
